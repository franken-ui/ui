export default {
    ...
    '.uk-text-background': {
        ...
        backgroundImage: 'var(--uk-text-background-image, linear-gradient(90deg, #1e87f0 0%, #411ef0 100%))' // Customizable background image/gradient
    },
    '.uk-paragraph': {
    ...
    '.uk-codespan': {
        ...
        fontFamily: 'var(--uk-codespan-font-family, ui-monospace,SFMono-Regular,Menlo,Monaco,Consolas,Liberation Mono,Courier New,monospace)',
    ...
    '.uk-kbd': {
        ...
        // Typography
        fontFamily: 'var(--uk-kbd-font-family, ui-monospace,SFMono-Regular,Menlo,Monaco,Consolas,Liberation Mono,Courier New,monospace)',
