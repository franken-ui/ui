export default {
    ...
    '.uk-input-pin input': {
        ...
        '&:focus': {
            ...
            // Transitions
            transitionProperty: 'var(--uk-input-pin-input-focus-transition-property, box-shadow)',
            transitionDuration: 'var(--uk-input-pin-input-focus-transition-duration, 150ms)',
            transitionTimingFunction: 'var(--uk-input-pin-input-focus-transition-timing, ease-in-out)',
            '&::placeholder': {
    ...
    '.uk-input-pin input:first-child': {
        borderRadius: 'var(--uk-input-pin-first-radius, var(--uk-form-input-radius) 0 0 var(--uk-form-input-radius))'
        // @note: removed ml-[1px] as it's commented out in original
    },
    '.uk-input-pin input:last-child': {
        borderRadius: 'var(--uk-input-pin-last-radius, 0 var(--uk-form-input-radius) var(--uk-form-input-radius) 0)'
    },
