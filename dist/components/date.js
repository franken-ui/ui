export default {
    ...
    '.uk-cal table tbody tr td button:hover': {
        ...
        color: 'var(--uk-cal-cell-hover-color, var(--uk-cal-cell-hover-color, hsl(var(--accent-foreground))))', // Customizable hover color, nested fallback
        transitionProperty: 'background-color', // Fixed transition property
        transitionDuration: 'var(--uk-cal-cell-hover-transition-duration, var(--uk-cal-hover-duration, 150ms))', // Customizable hover duration, nested fallback for backward compatibility
